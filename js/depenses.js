...
function afficherTableau() {
    ...
    if (depensesAffichees.length === 0) {
        ...
        tr.innerHTML = `<td colspan="4" style="text-align: center; padding: 20px; color: rgba(255,255,255,0.5);">Aucune dépense trouvée</td>`;
    ...
    depensesPage.forEach(dep => {
        ...
        tr.innerHTML = `
            ...
            <td>${escapeHtml(dep.titre)} ${dep.description ? `<br><small>${escapeHtml(dep.description)}</small>` : ""}</td>
